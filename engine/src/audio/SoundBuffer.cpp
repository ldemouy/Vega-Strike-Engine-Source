...
SoundBuffer::SoundBuffer() : buffer(0), byteCapacity(0), bytesUsed(0)
{
}

SoundBuffer::SoundBuffer(uint32_t capacity, const Format &format) : buffer(0), byteCapacity(0), bytesUsed(0)
{
...
void SoundBuffer::reserve(uint32_t capacity)
{
...
void SoundBuffer::reserve(uint32_t capacity, const Format &_format)
{
    format = _format;
