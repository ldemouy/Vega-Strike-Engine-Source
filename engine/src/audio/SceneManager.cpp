...
template <>
Audio::SceneManager *Singleton<Audio::SceneManager>::_singletonInstance = 0;
...
namespace Audio
{
    ...
    namespace __impl
    {
        ...
        struct SceneManagerData
        {
            ...
            SceneManagerData() : rootListener(new Listener()),
    ...
    struct SourcePriorityRef
    {
        ...
        SourcePriorityRef(SimpleScene::SourceIterator itr, const Listener &listener, SimpleScene *scn) : iter(itr),
                                                                                                         scene(scn),
