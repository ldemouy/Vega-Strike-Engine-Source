...
namespace Audio
{
    ...
    */
    ...
    public:
        ...
        reference_type get() { return operator*(); }
        pointer_type getPtr() { return operator->(); }

        iterator_type &next() { return operator++(); }
        iterator_type &prev() { return operator--(); }
    };

    template <typename _It>
    class VirtualStandardIterator : public VirtualIterator<
    ...
    public:
        ...
        virtual bool eos() const { return it.eos(); }
    ...
    class ChainingIterator : public VirtualIterator<
