...
class SceneManager : public Singleton<SceneManager>
{
  ...
  public:
     ...
     */
    void playSource(std::shared_ptr<SourceTemplate> tpl, const std::string &sceneName, LVector3 position,
     ...
     * @remarks The source should not be looping, and an exception will be thrown if it is.
     */
    void playSource(std::shared_ptr<SourceTemplate> tpl, const std::string &soundName, const std::string &sceneName,
                    LVector3 position, Vector3 direction, Vector3 velocity, Scalar radius);
