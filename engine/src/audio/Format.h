...
namespace Audio
{
    ...
    struct Format
    {
        ...
        Format(uint32_t freq, uint8_t bps, uint8_t nch) : sampleFrequency(freq),
                                                          bitsPerSample(bps),
                                                          channels(nch),
        ...
        {
            return (sampleFrequency == o.sampleFrequency) && (bitsPerSample == o.bitsPerSample) && (channels == o.channels) && (signedSamples == o.signedSamples) && (nativeOrder == o.nativeOrder);
        }
