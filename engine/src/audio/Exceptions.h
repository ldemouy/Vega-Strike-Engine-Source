...
namespace Audio
{
    ...
    {
    public:
        explicit DuplicateObjectException(const std::string &name) : Exception(std::string("Object with name \"") + name + "\" already existed") {}
    };
    ...
    {
    public:
        explicit NotFoundException(const std::string &name) : Exception(std::string("Object with name \"") + name + "\" does not exist") {}
    };
    ...
    {
    public:
        explicit NotImplementedException(const std::string &name) : Exception(name + " has not been implemented yet") {}
    };
    ...
    public:
        explicit UnsupportedFormatException(const std::string &where, const Format &fmt) : Exception(std::string("Unsupported format (" + where + ")")),
                                                                                           format(fmt)
        {
        }
