...
class Font
{
  public:
    ...
    Font(float newsize = .1, float weight = NORMAL_STROKE)
        : m_size(newsize), m_strokeWeight(weight), m_needMetrics(true), m_strokeWidth(1.0), m_extraCharWidth(0.5),
          m_spaceCharFixup(10.0), m_verticalScaling(1.0), m_horizontalScaling(1.0)
    {
    }
