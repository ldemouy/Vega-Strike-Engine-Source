...
//Constructor.
SimplePickerCell::SimplePickerCell(const std::string &t, const std::string &id, const GFXColor &c, int tag) : m_text(t), m_id(id), m_textColor(c), m_tag(tag), m_children(NULL)
{
}
