...
// by using templates.
template <class T> class ValuedPickerCell : public SimplePickerCell
{
  public:
    // CONSTRUCTION
    ValuedPickerCell(T value, const std::string &text, const std::string &id = "", const GFXColor &c = GUI_CLEAR,
                     int newTag = 0)
    ...
    ValuedPickerCell(const ValuedPickerCell &cell) : SimplePickerCell(cell), m_value(cell.m_value)
    {
    }
