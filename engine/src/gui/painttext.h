...
class PaintText
{
  ...
  public:
    PaintText(void);
    PaintText(const Rect &rect, const std::string &text, const Font &font, const GFXColor &color,
              Justification just = RIGHT_JUSTIFY, WidthExceeded w = ELLIPSIS);
  ...
  protected:
    ...
    void parseFragmentsWithCharBreak(
