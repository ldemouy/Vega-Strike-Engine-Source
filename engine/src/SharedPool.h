  ...
  public:
    class Reference
    {
      ...
      public:
        ...
        explicit Reference(ReferenceCounter *pool) : _it(pool->end()), _rc(pool)
        {
        }

        Reference(ReferenceCounter *pool, const T &s) : _it(pool->end()), _rc(pool)
        {
            set(s);
        }

        Reference(const Reference &other) : _it(other._it), _rc(other._rc)
        {
            ref();
        }
