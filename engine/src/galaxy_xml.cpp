...
void dotabs(VSFileSystem::VSFile &f, uint32_t tabs)
{
    for (uint32_t i = 0; i < tabs; ++i)
        f.Fprintf("\t");
}
void SGalaxy::writeSector(VSFileSystem::VSFile &f, int32_t tabs, const string &sectorType, SGalaxy *planet_types) const
{
