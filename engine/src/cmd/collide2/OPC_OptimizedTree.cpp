 ...
 *	\fn			_BuildNoLeafTree(AABBNoLeafNode* linear, const uint32_t box_id, uint32_t& current_id, const AABBTreeNode*
 *current_node) \param		linear			[in] base address of destination nodes
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static void _BuildNoLeafTree(AABBNoLeafNode *linear, const uint32_t box_id, uint32_t &current_id,
...
#define FIND_MAX_VALUES                                                                                                \
    /* Get max values */                                                                                               \
    Point CMax(std::numeric_limits<float>::min(), std::numeric_limits<float>::min(),                                   \
               std::numeric_limits<float>::min());                                                                     \
    Point EMax(std::numeric_limits<float>::min(), std::numeric_limits<float>::min(),                                   \
               std::numeric_limits<float>::min());                                                                     \
