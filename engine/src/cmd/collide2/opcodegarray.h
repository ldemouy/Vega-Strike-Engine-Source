...
#define CS_TYPEDEF_GROWING_ARRAY_REF(Name, Type)    \
  CS_TYPEDEF_GROWING_ARRAY_EXT(                     \
      Name, Type, RefCount = 0,                     \
      int RefCount;                                 \
      void IncRef() { RefCount++; } void DecRef() { \
        if (RefCount == 1)                          \
          SetLimit(0);                              \
        RefCount--;                                 \
      })
...
#define CS_DECLARE_GROWING_ARRAY(Name, Type)        \
  CS_TYPEDEF_GROWING_ARRAY(__##Name##_##Type, Type) \
  Name
...
#define CS_DECLARE_GROWING_ARRAY_REF(Name, Type) \
  CS_TYPEDEF_GROWING_ARRAY_REF(__##Name, Type)   \
  Name
