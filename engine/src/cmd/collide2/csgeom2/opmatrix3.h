...
class csMatrix3
{
  ...
  public:
    ...
    csMatrix3() : m11(1), m12(0), m13(0), m21(0), m22(1), m23(0), m31(0), m32(0), m33(1)
    {
    }

    /// Construct a matrix and initialize it.
    csMatrix3(float am11, float am12, float am13, float am21, float am22, float am23, float am31, float am32,
              float am33)
        : m11(am11), m12(am12), m13(am13), m21(am21), m22(am22), m23(am23), m31(am31), m32(am32), m33(am33)
    {
    }
    ...
    {
        csMatrix3 C((m22 * m33 - m23 * m32), -(m12 * m33 - m13 * m32), (m12 * m23 - m13 * m22),
    ...
    {
        return csVector3(m.m11 * v.x + m.m12 * v.y + m.m13 * v.z, m.m21 * v.x + m.m22 * v.y + m.m23 * v.z,
