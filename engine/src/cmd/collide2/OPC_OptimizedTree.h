...
#define IMPLEMENT_IMPLICIT_NODE(base_class, volume)                                                                    \
  public:                                                                                                              \
    ...
    /* Data access */                                                                                                  \
    inline const base_class *GetPos() const                                                                            \
    {                                                                                                                  \
        return (base_class *)mData;                                                                                    \
    }                                                                                                                  \
    inline const base_class *GetNeg() const                                                                            \
    {                                                                                                                  \
        return ((base_class *)mData) + 1;                                                                              \
    }                                                                                                                  \
    inline uint32_t GetPrimitive() const                                                                               \
    {                                                                                                                  \
        return (uint32_t)(mData >> 1);                                                                                 \
    }                                                                                                                  \
    /* Stats */                                                                                                        \
...
#define IMPLEMENT_NOLEAF_NODE(base_class, volume)                                                                      \
  public:                                                                                                              \
    ...
    /* Leaf tests */                                                                                                   \
    inline bool HasPosLeaf() const                                                                                     \
    {                                                                                                                  \
        return mPosData & 1;                                                                                           \
    }                                                                                                                  \
    inline bool HasNegLeaf() const                                                                                     \
    {                                                                                                                  \
        return mNegData & 1;                                                                                           \
    }                                                                                                                  \
    /* Data access */                                                                                                  \
    inline const base_class *GetPos() const                                                                            \
    {                                                                                                                  \
        return (base_class *)mPosData;                                                                                 \
    }                                                                                                                  \
    inline const base_class *GetNeg() const                                                                            \
    {                                                                                                                  \
        return (base_class *)mNegData;                                                                                 \
    }                                                                                                                  \
    inline uint32_t GetPosPrimitive() const                                                                            \
    {                                                                                                                  \
        return (uint32_t)(mPosData >> 1);                                                                              \
    }                                                                                                                  \
    inline uint32_t GetNegPrimitive() const                                                                            \
    {                                                                                                                  \
        return (uint32_t)(mNegData >> 1);                                                                              \
    }                                                                                                                  \
    /* Stats */                                                                                                        \
    inline uint32_t GetNodeSize() const                                                                                \
    {                                                                                                                  \
...
#define IMPLEMENT_COLLISION_TREE(base_class, node)                                                                     \
  public:                                                                                                              \
    ...
    /* Data access */                                                                                                  \
    inline const node *GetNodes() const                                                                                \
    {                                                                                                                  \
        return mNodes;                                                                                                 \
    }                                                                                                                  \
    /* Stats */                                                                                                        \
