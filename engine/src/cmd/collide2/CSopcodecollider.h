...
class csOPCODECollider
{
  private:
    ...
    static void MeshCallback(uint32_t triangle_index, VertexPointers &triangle, void *user_data);
  ...
  public:
    ...
    bool Collide(csOPCODECollider &pOtherCollider, const csReversibleTransform *pThisTransform = 0,
