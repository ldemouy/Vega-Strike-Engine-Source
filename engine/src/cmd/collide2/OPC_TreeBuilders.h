...
class AABBTreeBuilder
{
  public:
    //! Constructor
    AABBTreeBuilder() : mNbPrimitives(0), mNodeBase(nullptr), mCount(0), mNbInvalidSplits(0)
    {
    }
    //! Destructor
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    virtual float GetSplittingValue(const uint32_t * /*primitives*/, uint32_t /*nb_prims*/, const AABB &global_box,
                                    uint32_t axis) const
    {
    ...
    // Stats
    inline void SetCount(uint32_t nb)
    {
        mCount = nb;
    }
    inline void IncreaseCount(uint32_t nb)
    {
        mCount += nb;
    }
    ...
    inline void SetNbInvalidSplits(uint32_t nb)
    {
        mNbInvalidSplits = nb;
    }
    inline void IncreaseNbInvalidSplits()
    {
        mNbInvalidSplits++;
    }
