...
inline void ComputeReflexionVector(Point &reflected, const Point &incoming_dir, const Point &outward_normal)
{
	reflected = incoming_dir - outward_normal * 2.0f * (incoming_dir | outward_normal);
}

inline void ComputeReflexionVector(Point &reflected, const Point &source, const Point &impact, const Point &normal)
{
	Point V = impact - source;
	reflected = V - normal * 2.0f * (V | normal);
}

inline void DecomposeVector(Point &normal_compo, Point &tangent_compo, const Point &outward_dir, const Point &outward_normal)
{
...
/**
	 ...
	 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline void ComputeLocalDirection(Point &local_dir, const Point &world_dir, const Matrix4x4 &world)
{
...
/**
	 ...
	 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline void ComputeLocalPoint(Point &local_pt, const Point &world_pt, const Matrix4x4 &world)
{
...
/**
	 ...
	 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline void ComputeLocalRay(Ray &local_ray, const Ray &world_ray, const Matrix4x4 &world)
{
