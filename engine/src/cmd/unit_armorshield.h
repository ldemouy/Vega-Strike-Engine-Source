...
struct Armor
{
    ...
    Armor()
        : frontlefttop(0), backlefttop(0), frontrighttop(0), backrighttop(0), frontleftbottom(0), backleftbottom(0), frontrightbottom(0), backrightbottom(0) {}
};
#define MAX_SHIELD_NUMBER 8
struct ShieldFacing
{
    ShieldFacing()
        : thetamin(0.0), thetamax(0.0), rhomin(0.0), rhomax(0.0)
    {
    }
...
struct Shield
{
    ...
    Shield()
        : recharge(0), efficiency(0), number(0), leak(0)
    {
