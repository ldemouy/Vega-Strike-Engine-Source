...
struct Armor
{
    ...
    Armor()
        : frontlefttop(0), backlefttop(0), frontrighttop(0), backrighttop(0), frontleftbottom(0), backleftbottom(0),
          frontrightbottom(0), backrightbottom(0)
    {
    }
};
...
struct ShieldFacing
{
    ShieldFacing() : thetamin(0.0), thetamax(0.0), rhomin(0.0), rhomax(0.0)
    {
    }
...
struct Shield
{
    ...
    union {
        ...
        struct
        {
            float frontrighttop, backrighttop, frontlefttop, backlefttop, frontrightbottom, backrightbottom,
                frontleftbottom, backleftbottom;
            float frontrighttopmax, backrighttopmax, frontlefttopmax, backlefttopmax, frontrightbottommax,
                backrightbottommax, frontleftbottommax, backleftbottommax;
        } shield8;
        struct
        {
    ...
    Shield() : recharge(0), efficiency(0), number(0), leak(0)
    {
