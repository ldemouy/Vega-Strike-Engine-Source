...
template <class UnitType> class GameUnit : public UnitType
{
  ...
  public:
    ...
    /// Deprecated
    void addHalo(const char *filename, const Matrix &trans, const Vector &size, const GFXColor &col,
     ...
     **************************************************************************************
     */
    bool TransferUnitToSystem(unsigned int whichJumpQueue, StarSystem *&previouslyActiveStarSystem,
     ...
     **************************************************************************************
     */
    bool UpgradeSubUnits(const Unit *up, int subunitoffset, bool touchme, bool downgrade, int &numave,
                         double &percentage);
...
class Asteroid;
template <class Asteroid> class GameUnit;

class Building;
template <class Building> class GameUnit;

class Planet;
template <class Planet> class GameUnit;

class Unit;
template <class Unit> class GameUnit;

class Missile;
template <class Missile> class GameUnit;

class Nebula;
template <class Nebula> class GameUnit;

class Enhancement;
template <class Enhancement> class GameUnit;
