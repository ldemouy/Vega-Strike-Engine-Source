...
class Cockpit
{
  ...
  public:
    ...
    static bool tooManyAttackers(); // checks config file and declares if too many folks are attacking any of the
                                    // players (to avoid expensive tests where unnecessary).
