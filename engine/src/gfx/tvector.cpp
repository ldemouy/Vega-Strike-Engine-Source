...
template void CrossProduct(const TVector<float, double> &a, const TVector<float, double> &b, TVector<float, double> &RES);
template void CrossProduct(const TVector<double, float> &a, const TVector<double, float> &b, TVector<double, float> &RES);

template void ScaledCrossProduct(const TVector<float, double> &a, const TVector<float, double> &b, TVector<float, double> &r);
template void ScaledCrossProduct(const TVector<double, float> &a, const TVector<double, float> &b, TVector<double, float> &r);
...
template TVector<float, double> Transform(TVector<float, double> p, TVector<float, double> q, TVector<float, double> r, TVector<float, double> v);
template TVector<double, float> Transform(TVector<double, float> p, TVector<double, float> q, TVector<double, float> r, TVector<double, float> v);
