...
namespace Radar
{
    ...
    PlaneDisplay::PlaneDisplay()
        : impl(new PlaneDisplay::Impl), finalCameraAngle(Degree2Radian(30), Degree2Radian(0), Degree2Radian(0)), currentCameraAngle(finalCameraAngle), radarTime(0.0), lastAnimationTime(0.0)
    {
