...
BubbleDisplay::BubbleDisplay()
    : impl(new BubbleDisplay::Impl), innerSphere(0.45), outerSphere(1.0), sphereZoom(1.0), radarTime(0.0),
      currentTargetMarkerSize(0.0), lastAnimationTime(0.0)
{
    using namespace boost::assign; // vector::operator+=
    explodeSequence += 0.0, 0.0001, 0.0009, 0.0036, 0.0100, 0.0225, 0.0441, 0.0784, 0.1296, 0.2025, 0.3025, 0.4356,
        0.6084, 0.8281, 1.0, 0.8713, 0.7836, 0.7465, 0.7703, 0.8657, 1.0, 0.9340, 0.9595, 1.0, 0.9659, 1.0;
    implodeSequence += 1.0, 0.9999, 0.9991, 0.9964, 0.9900, 0.9775, 0.9559, 0.9216, 0.8704, 0.7975, 0.6975, 0.5644,
