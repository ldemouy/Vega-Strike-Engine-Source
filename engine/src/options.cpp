...
void vs_options::init()
{
    ...
    intro1 = vs_config->getVariable("general", "intro1",
                                    "Welcome to Vega Strike! Use #8080FFTab#000000 to afterburn (#8080FF+,-#000000 "
                                    "cruise control), #8080FFarrows#000000 to steer.");
    intro2 = vs_config->getVariable("general", "intro2",
                                    "The #8080FFt#000000 key targets objects; #8080FFspace#000000 fires at them & "
                                    "#8080FFa#000000 activates the SPEC drive. To");
    intro3 = vs_config->getVariable("general", "intro3",
                                    "go to another star system, buy a jump drive for about 10000 credits, fly to a");
    intro4 = vs_config->getVariable(
        "general", "intro4",
        "wireframe jump-point and press #8080FFj#000000 to warp to a near star. Target a base or planet;");
    intro5 = vs_config->getVariable(
        "general", "intro5", "When you get close a green box will appear. Inside the box, #8080FFd#000000 will land.");
    ...
    always_make_smooth_cam =
        XMLSupport::parse_bool(vs_config->getVariable("graphics", "always_make_smooth_cam", "false")); // Not used yet
    ...
    campaigns = vs_config->getVariable("physics", "campaigns",
    ...
    //    SmallUnitsMultiplier   = XMLSupport::parse_floatf( vs_config->getVariable( "galaxy", "SmallUnitsMultiplier",
    //    "0" ) );
    ...
    account_server_url = vs_config->getVariable("network", "account_server_url",
