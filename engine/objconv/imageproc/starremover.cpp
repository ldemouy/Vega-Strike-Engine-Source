            ...
            for (int k = -1; k <= 1; k++)
                for (int l = -1; l <= 1; l++)
                    if (k || l) {
                        int x = i+k;
                        int y = j+l;
                        if (row_pointers[x][y*stride] != 0
                            || row_pointers[x][y*stride+1] != 0
                            || row_pointers[x][y*stride+2] != 0)
                            suc = false;
                    }
            if (suc) {
                row_pointers[i][j*stride]   = 0;
                row_pointers[i][j*stride+1] = 0;
                row_pointers[i][j*stride+2] = 0;
            }
        }
}
