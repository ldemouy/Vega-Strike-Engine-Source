...
#define GET_TITLE                                                                                                      \
    char title[1000] = "Vega Strike Settings";                                                                         \
    if (strlen(CONFIG.program_name) + strlen(VERSION) < 800)                                                           \
    {                                                                                                                  \
        sprintf(title, "Settings - %s - Version 0.7.0", CONFIG.program_name);                                          \
    }

#define GET_STATIC_TEXT                                                                                                \
    char static_text[1000] = "Vega Strike requires \
